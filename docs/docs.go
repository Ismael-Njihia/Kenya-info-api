...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "url": "https://github.com/Ismael-Njihia/Kenya-info-api",
            "email": "support@kenyainfo.api"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
        ...
        "/api/v1/leaders/position/{position}": {
            "get": {
